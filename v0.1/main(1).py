...
def mode_calibrate(vr):
    """
    Run the interactive 3-point room calibration wizard.
    Overwrites any existing room_calibration.json.
    """
    ...
    if result:
        print("✓ Calibration saved. Run 'python main.py print' next.")
    else:
...
def mode_print(vr, frequency, skip_relocalize):
    """
...
def mode_view(vr, frequency, skip_relocalize):
    """
